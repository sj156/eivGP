...
if (!exists("mixedgp_summarize_diagnostic_series", mode = "function")) {
  ...
  diagnostic_candidates <- c(
    if (!is.null(diagnostic_source_file)) file.path(dirname(diagnostic_source_file), "00_diagnostics.R"),
    "00_diagnostics.R", file.path("codes", "00_diagnostics.R"),
    file.path("revision", "codes", "00_diagnostics.R")
  )
