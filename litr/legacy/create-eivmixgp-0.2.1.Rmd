---
title: "Historical eivmixgp 0.2.1 build source (retired)"
...
writeLines(
  c(
    ...
    "- Both modes retain diagnostic flags without gate-triggered stops.",
    "- Study II measurement warnings no longer suppress PI-GP/CC-GP estimates.",
    "- Missing competitors warn by default; data errors still stop.",
    "- Full orchestration and separate fit/evaluation caching remain pending.",
    "",
    "# eivmixgp 0.2.0",
    "",
...
testthat::test_that("both numerical studies use one validated interface", {
  ...
  testthat::expect_false(abbreviated$strict_competitors)
