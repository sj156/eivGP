...
Gibbs.param.True <- list(
  B.tilde = B.tilde.true,
  Sigma.u = Sigma.u.true,
...
#U0 <- matrix(0, n, d)
U0 <- get.initial("nominal", Gibbs.data)$U0
#print(U0)
Gibbs.param.initial.eb <- list(
  B.tilde0 = B.tilde0,
  Sigma.u0 = Sigma.u0,
  gamma.mat0 = gamma.mat0,   
  U0 = U0 
)


samples.eb <- Gibbs.EB.nominal(
...
#U.hist <- matrix(0, n, d)
U.hist <- get.initial("nominal", Gibbs.data)$U0
...
for (cycles in 1:120) {
  ...
  Gibbs.param.initial <- list(
    B.tilde0 = B.tilde0,
    Sigma.u0 = Sigma.u0,
    sigma.error20 = sigma.error20,
    gamma.mat0 = gamma.mat0,
    U0 = U0
  )
  # Run Gibbs for the current cycle 
  Gibbs1 <- Gibbs.nominal(
    Gibbs.data = Gibbs.data,
