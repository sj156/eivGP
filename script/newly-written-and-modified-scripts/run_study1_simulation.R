...
## freezes the paired eta design, task-eligible methods, MCMC controls, seeds,
## and reportable run sizes. Edit the returned list only before data generation.
...
STUDY1_RUN <- run_study1_simulation(CONFIG)
